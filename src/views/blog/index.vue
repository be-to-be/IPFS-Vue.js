  ...
  methods: {
    ...
    setImage(a){
      ...
      async setBlog(){
        ...
        console.log(this.recommendations_data)
        this.blog_building = false
        // this.setImage(a)

        // var e = new URL('https://ipfs.io/ipfs/' + this.$route.params.id);
        // var b = await fetch(e.toString())
        // console.log(b)
        // var client = new Web3Storage({ token: this.apiToken });
        // var cid = new CID(this.$route.params.id)
        // var str = cid.toString()
        // // console.log(str)
        // const res = await client.get(str);
        // const files = await res.files();
        // var fr=new FileReader();
        // await fr.readAsText(files[0]);
        // this.addListeners(fr);
      },
